...
export default function LoginPage() {
  ...
  return (
    <main className="py-16 grid place-items-center">
      <form onSubmit={onSubmit} className="card max-w-md w-full p-6 sm:p-8 space-y-6" aria-label="Log in form">
        <div className="space-y-2 text-center">
          <h1 className="text-2xl font-bold">Log In</h1>
          <p className="text-sm text-muted-foreground">Use your university email to continue.</p>
        </div>
